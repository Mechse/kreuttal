    ...
    <section class="clean-block clean-info dark">
        <div class="container">
            <div class="block-heading">
                ...
                <button class="btn btn-outline-primary btn-lg" type="button" onclick="window.location='{{ url("/facilities")}}'">Anlage</button>
            </div>
        </div>
    </section>
    <section class="clean-block features">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    <button class="btn btn-outline-primary btn-lg" type="button" onclick="window.location='{{ url("/price")}}'">Preise</button>
                </div>
            </div>
        </div>
    </section>
    <section class="clean-block clean-info dark">
        <div class="row align-items-center reverse">
            ...
            <div class="col-md-6 button-margin">
                ...
                <button class="btn btn-outline-primary btn-lg" type="button" onclick="window.location='{{ url("/calender")}}'">Kalender</button>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-md-6 button-margin">
                ...
                <button class="btn btn-outline-primary btn-lg" type="button" onclick="window.location='{{ url("/club")}}'">Verein</button>
            </div>
